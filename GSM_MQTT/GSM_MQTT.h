...
#define TOPIC_BUFFER_LENGTH 200    //Maximum length allowed Topic
...
public:
    ...
    void parsePacket(uint8_t ReceivedMessageType, uint8_t DUP, uint8_t QoS, uint8_t RETAIN);
    ...
    unsigned int _LastMessaseID;
    char _ProtocolVersion;
    unsigned long _PingPrevMillis;
    char _tcpStatus;
    char _tcpStatusPrev;
